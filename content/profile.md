---
name: Lucas Dixon
tagline: Research Scientist — visualisation, interpretability and control of machine learning systems
photoUrl: ''
scholarUserId: nDs3-TMAAAAJ
links:
  - label: Google Scholar
    url: https://scholar.google.com/citations?user=nDs3-TMAAAAJ&hl=en&oi=ao
  - label: PAIR
    url: https://pair.withgoogle.com/
  - label: GitHub
    url: https://github.com/iislucas
---

I am a principal research scientist in Google DeepMind and co-lead of [PAIR](https://pair.withgoogle.com) (People and AI Research). I work on visualisation, interpretability and control of machine learning systems, and specifically language models.
...
Before Google, I completed my PhD and worked in [the DREAM group](https://www.research.ed.ac.uk/en/publications/the-history-of-the-dream-group) in [Informatics at the University of Edinburgh](https://informatics.ed.ac.uk/) on the automation of mathematical reasoning, and later worked on graphical languages applied to quantum information.
